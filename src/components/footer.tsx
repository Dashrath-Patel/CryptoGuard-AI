        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="text-neutral-400 text-sm mt-2 text-center md:text-left">
                Making crypto safe and simple for everyone
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8">
              <div className="flex space-x-6">
                ...
                <a href="/docs" className="text-neutral-400 hover:text-white transition-colors text-sm">
                  Docs
                </a>
              </div>
          ...
          <div className="border-t border-neutral-800 mt-8 pt-4 text-center">
            <p className="text-neutral-400 text-xs">
              © 2025 CryptoGuard AI. Built for the hackathon. Making crypto safe for everyone.
            </p>
          </div>
        </div>
      </BackgroundLines>
